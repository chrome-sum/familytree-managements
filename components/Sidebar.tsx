...
import { Plus, Users, Search, ChevronRight, Edit2, Download, Upload, LogIn, LogOut, Settings, User } from 'lucide-react'
...
export default function Sidebar({
  ...
  const { isLoggedIn, setLoginModalOpen, setSettingsModalOpen, logout } = useFamilyTree()
      ...
      <div className="p-6 mt-auto shrink-0 border-t border-white/5 bg-zinc-900/50 flex flex-col gap-4">
        <div className="flex items-center justify-between">
          <div className="flex gap-2">
            ...
            <button 
              ...
              title={isLoggedIn ? "Logout Admin" : "Login Admin"}
              className={cn(
        ...
        {isLoggedIn ? (
          ...
          <div className="text-center py-2">
            <p className="text-[10px] text-zinc-500 uppercase tracking-widest font-bold">Mode Lihat Saja</p>
          </div>
        )}
      </div>
    </aside>
